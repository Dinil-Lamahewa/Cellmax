  ...
  return <section id="performance" className="py-24 bg-gradient-to-b from-[#1a1f2e] to-[#0a0e1a] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10" ref={ref}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          duration: 0.6,
          delay: index * 0.1
        }} className="bg-[#1a1f2e] border border-[#FFD700]/20 rounded-2xl p-8 hover:border-[#FFD700] hover:shadow-lg hover:shadow-[#FFD700]/20 transition-all duration-300 group">
